/*
 * プログラム名：Step6：同一クラス内で処理をメソッド化する（クラスメソッド）
 *  プログラムの説明：Step5のソースコードをもとに、
 *  				点数を評価する部分の処理をメソッド化します。
				メソッドは同一クラス内にクラスメソッドとして定義します。
 *  作成者：オ　サン　ミン
 *  作成日：2021/10/15
 */
...
public class ScoreJudgeS06 {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			char evaluate = evaluateScore(score);
			...
			System.out.println("→評価" + evaluate + "です。");
